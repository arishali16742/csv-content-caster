...
const Oceania = () => {
  ...
  const [destinations, setDestinations] = useState<OceaniaDestination[]>([]);
  ...
  const sectionTitle = getSectionTitle('oceania', 'EXPLORE OCEANIA');
  const sectionSubtitle = getSectionSubtitle('oceania', 'Discover amazing destinations in the Oceania collection');
