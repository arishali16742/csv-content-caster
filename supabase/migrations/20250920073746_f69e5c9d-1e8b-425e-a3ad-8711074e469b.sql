-- Drop and recreate the get_all_bookings_with_details function to include admin response fields
DROP FUNCTION IF EXISTS public.get_all_bookings_with_details();
